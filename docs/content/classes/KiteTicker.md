...
> **new KiteTicker**(`params`): `KiteTicker`
...
> `readonly` **modeQuote**: `"quote"` = `'quote'`
...
Enable or disable auto disconnect, defaults to false
...
Register websocket event callbacks. See [TickerEvent](../type-aliases/TickerEvent.md) for all available events.

#### Type Parameters

##### K

`K` *extends* keyof [`TickerEvents`](../type-aliases/TickerEvents.md)
...
Event to register callback on.

##### callback

[`TickerEvents`](../type-aliases/TickerEvents.md)\[`K`\]
...
Array of tokens to be subscribed
...
Array of tokens to be unsubscribed
