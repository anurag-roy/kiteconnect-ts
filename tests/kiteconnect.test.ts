...
test('getOrders', async (t) => {
  await t.test('Retrieve the list of all orders under orderbook', async () => {
...
test('getAuctionInstruments', async (t) => {
  await t.test(
    'Retrieves list of available instruments for a auction session',
    async () => {
...
test('getHistoricalData', async (t) => {
  // for intraday candle
  await t.test(
...
test('getGTTs', async (t) => {
  await t.test('Fetch list of all GTTs visible in GTT order book', async () => {
...
test('getGTT', async (t) => {
  await t.test('Fetch specific gtt order detail using trigger_id', async () => {
